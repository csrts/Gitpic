...
function install {
	...
	*) fail "unknown os: $(uname -s)";;
	...
	case "${OS}_${ARCH}" in
	"darwin_amd64")
		URL="https://github.com/jpillora/cloud-torrent/releases/download/0.8.25/cloud-torrent_darwin_amd64.gz"
		FTYPE=".gz"
		;;
	"linux_386")
		URL="https://github.com/jpillora/cloud-torrent/releases/download/0.8.25/cloud-torrent_linux_386.gz"
		FTYPE=".gz"
		;;
	"linux_amd64")
		URL="https://github.com/jpillora/cloud-torrent/releases/download/0.8.25/cloud-torrent_linux_amd64.gz"
		FTYPE=".gz"
		;;
	"linux_arm")
		URL="https://github.com/jpillora/cloud-torrent/releases/download/0.8.25/cloud-torrent_linux_arm.gz"
		FTYPE=".gz"
		;;
